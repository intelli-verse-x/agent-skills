...
## Summary
- 16658 nodes · 18488 edges · 1365 communities (1202 shown, 163 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 106 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `72a4daee`
...
Cohesion: 0.06
Nodes (25): Gc(), Hc(), ia(), ja(), kb(), Lc(), Md(), Nc() (+17 more)
...
Cohesion: 0.05
Nodes (44): 3.1.1(a) Link to Other Purchase Methods, 3.1.1 In-App Purchase, 3.1.2(a) Permissible Uses, 3.1.2(b) Upgrades and Downgrades, 3.1.2(c) Subscription Information, 3.1.2 Subscriptions, 3.1.3(a) "Reader" Apps, 3.1.3(b) Multiplatform Services (+36 more)
...
Cohesion: 0.05
Nodes (37): Asset Tools, batch_execute, Camera Tools, Custom Tools, execute_custom_tool, find_in_file, GameObject Tools, get_test_job (+29 more)
...
Cohesion: 0.08
Nodes (22): AnimatedGraph, AreaUnderCurve, BasicAxes, CoordinateLabeling, ImplicitFunction, MultipleFunctions, NumberPlaneExample, PolarPlot (+14 more)
...
Cohesion: 0.08
Nodes (25): 5.1.1 Data Collection and Storage, 5.1.3 Health and Health Research, 5.1.4 Kids, 5.1.5 Location Services, 5.1 Privacy, (a) Children's Privacy Laws and Data Collection, (b) Third-Party Services in Kids Apps, Common Rejection Reasons for Permissions (+17 more)
...
Cohesion: 0.08
Nodes (24): 4.10 Monetizing Built-In Capabilities, 4.1(a) Original Ideas, 4.1(b) Impersonation, 4.1(c) Trademark and Brand Usage, 4.1 Copycats, 4.3(a) Bundle ID Restrictions, 4.3(b) Category Saturation, 4.3 Spam (+16 more)
...
Cohesion: 0.09
Nodes (22): 5.2.1 Generally, 5.2.2 Third-Party Sites/Services, 5.2.3 Audio/Video Downloading, 5.2.4 Apple Endorsements, 5.2.5 Apple Products, 5.2 Intellectual Property, 5.3.1 Sweepstakes and Contests, 5.3.2 Official Rules (+14 more)
...
Cohesion: 0.15
Nodes (9): VGroup, Get current displacement., Integrate physics using simple Euler method., Get a dynamic vector showing velocity., Get a dynamic vector showing net force., A reusable spring-mass system component with physics simulation. This is a…, Create the mass block with label., Set displacement from equilibrium position. (+1 more)
...
Cohesion: 0.10
Nodes (21): 2.5.11(i) Appropriate Intent Registration, 2.5.11(ii) Vocabulary and Aliases, 2.5.11(iii) Direct Request Resolution, 2.5.11 SiriKit and Shortcuts, 2.5.12 CallKit, SMS Blocking, and Spam Identification, 2.5.13 Facial Recognition, 2.5.14 Recording and User Activity Logging, 2.5.15 File Selection and Display (+13 more)
...
Cohesion: 0.14
Nodes (12): ConeUnfolding, ParametricSurface3D, InteractiveScene, 3D Surfaces and Camera Movement Demonstrates 3D surface creation, parametric…, A cone that unfolds into a flat sector. Demonstrates surface transformation., Hyperbolic paraboloid (saddle surface). Classic example of negative Gaussian…, Creates a beautiful 3D parametric surface with camera rotation., Creates a torus (donut shape). Classic example of parametric surface. (+4 more)
...
Cohesion: 0.17
Nodes (17): Ae(), ce(), $d(), ee(), ga(), ha(), he(), ka() (+9 more)
...
Cohesion: 0.12
Nodes (16): 2.3.10 Platform Focus and Metadata Relevance, 2.3.11 Pre-Order Accuracy, 2.3.12 "What's New" Text, 2.3.13 In-App Events, 2.3.1(a) Feature Disclosure, 2.3.1(b) Egregious Behavior, 2.3.1 Hidden/Undocumented Features and Misleading Marketing, 2.3.2 In-App Purchase Disclosure (+8 more)
...
Cohesion: 0.24
Nodes (14): applyDuration(), applyMeta(), applyPoster(), applyStatus(), buildFrame(), DEFAULT_FRAME_STATUS, FRAME_STATUSES, isFrameStatus() (+6 more)
...
Cohesion: 0.13
Nodes (15): 2.4.1 Multi-Device Support, 2.4.2 Power Efficiency and Device Strain, 2.4.3 Apple TV Hardware Input Requirements, 2.4.4 Device Restart and System Settings, 2.4.5(i) Sandboxing and File System, 2.4.5(ii) Packaging and Installation, 2.4.5(iii) Auto-Launch and Startup Code, 2.4.5(iv) Code and Resource Installation (+7 more)
...
Cohesion: 0.19
Nodes (7): 2.1(a) Final Version Requirements, 2.1 App Completeness, 2.1(b) In-App Purchase Requirements, 2.2 Beta Testing, 2. PERFORMANCE, React Native Packages Reference, React Native Pre-Submission Checklist
...
Cohesion: 0.17
Nodes (9): Scene, QueryMap, Demonstrates causal masking in attention., Shows a large attention pattern scaling up., Simple scene showing a reminder about overall maps., Shows how embedding space maps to query/key space., ScalingAPattern, ShowMasking (+1 more)
...
Cohesion: 0.24
Nodes (6): MultiHeadedAttention, LaggedStart, Create a procedural attention pattern grid., Compute softmax of logits array., Demonstrates multi-headed attention with procedural patterns., softmax()
...
Cohesion: 0.28
Nodes (7): break_into_pieces(), break_into_words(), Attention Mechanism Scenes - ManimGL Examples A collection of scenes from…, Break a Text mobject into pieces at given character offsets., Shows how context disambiguates 'Harry'., Break a Text mobject into individual words., TwoHarrysExample
...
Cohesion: 0.40
Nodes (3): ParametricCurve, Plotting parametric curves., Create a 3D helix spring using parametric curve.
...
Cohesion: 0.50
Nodes (5): assignGlobal(), emptyGlobals(), findFrontmatterRange(), parseFrontmatter(), parseFrontmatterEntries()
...
## Knowledge Gaps
- **9703 isolated node(s):** `create-boards.sh script`, `install-config.sh script`, `queue-proof-run.sh script`, `install.sh script`, `uninstall.sh script` (+9698 more)
...
- **What connects `create-boards.sh script`, `install-config.sh script`, `queue-proof-run.sh script` to the rest of the system?**
  _9703 weakly-connected nodes found - possible documentation gaps or missing edges._
