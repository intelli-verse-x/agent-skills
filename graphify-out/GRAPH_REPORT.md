...
## Summary
- 16667 nodes · 18390 edges · 1368 communities (1205 shown, 163 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 65 edges (avg confidence: 0.58)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f5cef275`
...
- `ScaledDotProductAttention` --uses--> `NumericEmbedding`  [INFERRED]
  skills/ivx-om-manimce-best-practices/examples/attention/scenes.py → skills/ivx-om-manimce-best-practices/examples/attention/helpers.py
- `QueryKeyValueExplanation` --uses--> `WeightMatrix`  [INFERRED]
  skills/ivx-om-manimce-best-practices/examples/attention/scenes.py → skills/ivx-om-manimce-best-practices/examples/attention/helpers.py
...
- `AttentionPatterns` --uses--> `ContextAnimation`  [INFERRED]
  skills/ivx-om-manimce-best-practices/examples/attention/scenes.py → skills/ivx-om-manimce-best-practices/examples/attention/helpers.py

## Import Cycles
- None detected.

## Communities (1368 total, 163 thin omitted)
...
Cohesion: 0.10
Nodes (20): AttentionPattern, get_paragraph(), NeuralNetwork, NumericEmbedding, Animation, ndarray, VGroup, RandomizeMatrixEntries (+12 more)
...
Cohesion: 0.08
Nodes (24): 5.1.1 Data Collection and Storage, 5.1.2 Data Use and Sharing, 5.1.3 Health and Health Research, 5.1.4 Kids, 5.1.5 Location Services, 5.1 Privacy, (a) Children's Privacy Laws and Data Collection, (b) Third-Party Services in Kids Apps (+16 more)
...
Cohesion: 0.12
Nodes (15): break_into_pieces(), break_into_words(), CrossAttention, get_piece_rectangles(), QueryMap, Attention Mechanism Scenes - ManimGL Examples A collection of scenes from…, Simple scene showing a reminder about overall maps., Shows cross-attention between two languages. (+7 more)
...
Cohesion: 0.13
Nodes (14): MultiHeadedAttention, ThreeDScene, Explains multi-head attention mechanism with 3D visualization. Shows multiple…, MultiHeadedAttention, LaggedStart, Scene, Create a procedural attention pattern grid., Demonstrates causal masking in attention. (+6 more)
...
Cohesion: 0.20
Nodes (9): ContextAnimation, LaggedStart, random_bright_color(), Animation showing context flow from source words to target word. Creates arcing…, Helper to animate attention flow from multiple sources to a target., Generate a random bright color within a hue range., show_attention_flow(), AttentionPatterns (+1 more)
...
- **Why does `3D Text Depth Layers` connect `Community 207` to `Community 66`?**
