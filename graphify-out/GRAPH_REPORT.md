...
## Summary
- 16663 nodes · 18422 edges · 1375 communities (1212 shown, 163 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 101 edges (avg confidence: 0.55)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d3c71c78`
...
9. `scanProject()` - 21 edges
10. `validateProject()` - 21 edges

## Surprising Connections (you probably didn't know these)
- `process_episode()` --calls--> `slugify()`  [INFERRED]
  skills/ivx-ams-podcast-ops/podcast_pipeline.py → skills/ivx-ams-video-clip-pipeline/clip_cutter.py
- `AttentionMatrixVisualization` --uses--> `NumericEmbedding`  [INFERRED]
  skills/ivx-om-manimce-best-practices/examples/attention/scenes.py → skills/ivx-om-manimce-best-practices/examples/attention/helpers.py
- `AttentionPatterns` --uses--> `NumericEmbedding`  [INFERRED]
  skills/ivx-om-manimce-best-practices/examples/attention/scenes.py → skills/ivx-om-manimce-best-practices/examples/attention/helpers.py
- `MultiHeadedAttention` --uses--> `NumericEmbedding`  [INFERRED]
  skills/ivx-om-manimce-best-practices/examples/attention/scenes.py → skills/ivx-om-manimce-best-practices/examples/attention/helpers.py
- `PositionalEncoding` --uses--> `NumericEmbedding`  [INFERRED]
  skills/ivx-om-manimce-best-practices/examples/attention/scenes.py → skills/ivx-om-manimce-best-practices/examples/attention/helpers.py

## Import Cycles
- None detected.

## Communities (1375 total, 163 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.06
Nodes (64): adoptExistingAssets(), AUDIO_EXT, findExistingAsset(), IMAGE_EXT, inferType(), scanExistingAssets(), VIDEO_EXT, walkDir() (+56 more)
...
Cohesion: 0.06
Nodes (18): ia(), ja(), Lc(), Md(), Nc(), Nd(), oa(), Od() (+10 more)
...
Cohesion: 0.09
Nodes (22): Authentication, Basic Embed, CSS Customization, Custom Avatar, Custom Colors, Custom Text, Custom Trigger Button, Examples (+14 more)
...
Cohesion: 0.50
Nodes (4): Audio Issues, CORS Errors, Troubleshooting, Widget Not Appearing
