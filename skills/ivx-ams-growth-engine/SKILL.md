---
name: ivx-ams-growth-engine
description: >-
  Run autonomous marketing A/B experiments with hypotheses, bootstrap CI, Mann-Whitney
  scoring, weekly scorecards, and pacing alerts. Use for growth experiments, channel
  tests, playbook promotion, or weekly marketing scorecards.
metadata:
  source: https://github.com/ericosiu/ai-marketing-skills
  upstream_dir: growth-engine
...
```bash
cd ~/.cursor/skills/ams-growth-engine
# Windows: cd $env:USERPROFILE\.cursor\skills\ams-growth-engine
```
