---
name: ivx-ams-yt-competitive-analysis
description: >-
  Analyze YouTube channels for outlier videos and packaging patterns. Use for YouTube
  competitive analysis, viral patterns, or title/packaging inspiration.
metadata:
  source: https://github.com/ericosiu/ai-marketing-skills
  upstream_dir: yt-competitive-analysis
...
```bash
cd ~/.cursor/skills/ams-yt-competitive-analysis
# Windows: cd $env:USERPROFILE\.cursor\skills\ams-yt-competitive-analysis
```
