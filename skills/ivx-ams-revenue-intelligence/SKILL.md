---
name: ivx-ams-revenue-intelligence
description: >-
  Prove content ROI and extract strategy from sales calls: Gong insights, revenue
  attribution, client reports. Use for call insights, content attribution, or client
  reporting.
metadata:
  source: https://github.com/ericosiu/ai-marketing-skills
  upstream_dir: revenue-intelligence
