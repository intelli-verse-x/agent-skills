---
name: ivx-ams-deck-generator
description: >-
  Generate professional slide decks with AI images and style presets. Use for pitch decks,
  presentations, or Google Slides assembly.
metadata:
  source: https://github.com/ericosiu/ai-marketing-skills
  upstream_dir: deck-generator
...
```bash
cd ~/.cursor/skills/ams-deck-generator
# Windows: cd $env:USERPROFILE\.cursor\skills\ams-deck-generator
```
