---
name: ivx-ams-lead-dossier
description: >-
  Multi-source account research and lead pipeline: scrape, enrich, verify, dedupe. Use for
  lead dossiers, account research, or cascade enrichment.
metadata:
  source: https://github.com/ericosiu/ai-marketing-skills
  upstream_dir: lead-dossier
...
```bash
cd ~/.cursor/skills/ams-lead-dossier
# Windows: cd $env:USERPROFILE\.cursor\skills\ams-lead-dossier
```
