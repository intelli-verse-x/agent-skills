---
name: ivx-ams-seo-ops
description: >-
  SEO intelligence: content attack briefs, GSC optimization, competitor keyword gaps, and
  trend scouting. Use for SEO audits, keyword gaps, GSC fixes, or content attack briefs.
metadata:
  source: https://github.com/ericosiu/ai-marketing-skills
  upstream_dir: seo-ops
...
```bash
cd ~/.cursor/skills/ams-seo-ops
# Windows: cd $env:USERPROFILE\.cursor\skills\ams-seo-ops
```
