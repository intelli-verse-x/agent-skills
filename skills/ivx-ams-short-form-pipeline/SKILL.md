---
name: ivx-ams-short-form-pipeline
description: >-
  Extract viral short-form clips from long YouTube videos: download, transcribe, AI
  segment, cut, vertical crop, captions. Use for TikTok/Reels/Shorts clipping from
  long-form.
metadata:
  source: https://github.com/ericosiu/ai-marketing-skills
  upstream_dir: short-form-pipeline
...
```bash
cd ~/.cursor/skills/ams-short-form-pipeline
# Windows: cd $env:USERPROFILE\.cursor\skills\ams-short-form-pipeline
```
