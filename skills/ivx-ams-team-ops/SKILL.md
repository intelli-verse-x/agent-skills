---
name: ivx-ams-team-ops
description: >-
  Ruthless team performance audits (Elon Algorithm) and meeting-to-action extraction. Use
  for performance audits, meeting action items, or org efficiency reviews.
metadata:
  source: https://github.com/ericosiu/ai-marketing-skills
  upstream_dir: team-ops
...
```bash
cd ~/.cursor/skills/ams-team-ops
# Windows: cd $env:USERPROFILE\.cursor\skills\ams-team-ops
```
