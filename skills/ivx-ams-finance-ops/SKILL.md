---
name: ivx-ams-finance-ops
description: >-
  AI CFO briefings from QuickBooks exports, burn/runway, scenario modeling, and build-cost
  estimates. Use for CFO briefing, runway analysis, or development cost estimates.
metadata:
  source: https://github.com/ericosiu/ai-marketing-skills
  upstream_dir: finance-ops
...
```bash
cd ~/.cursor/skills/ams-finance-ops
# Windows: cd $env:USERPROFILE\.cursor\skills\ams-finance-ops
```
