---
name: ivx-ams-video-clip-pipeline
description: >-
  Convert long-form YouTube episodes into highlight clips: download, transcribe, segment,
  cut, upload. Use for YouTube clip pipelines or episode highlight extraction.
metadata:
  source: https://github.com/ericosiu/ai-marketing-skills
  upstream_dir: video-clip-pipeline
...
```bash
cd ~/.cursor/skills/ams-video-clip-pipeline
# Windows: cd $env:USERPROFILE\.cursor\skills\ams-video-clip-pipeline
```
