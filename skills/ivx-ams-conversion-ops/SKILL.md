---
name: ivx-ams-conversion-ops
description: >-
  CRO audit any landing page and turn survey data into lead magnets. Use for conversion
  rate optimization, landing page scoring, or survey-to-lead-magnet.
metadata:
  source: https://github.com/ericosiu/ai-marketing-skills
  upstream_dir: conversion-ops
...
```bash
cd ~/.cursor/skills/ams-conversion-ops
# Windows: cd $env:USERPROFILE\.cursor\skills\ams-conversion-ops
```
